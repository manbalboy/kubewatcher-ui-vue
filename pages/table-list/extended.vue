<template>
  <div>
    <div class="row"><RouteBreadCrumb /></div>
    <card>
        ...
        <div class="col-sm-12">
          <el-table :data="tableData">
            <el-table-column min-width="50" label="#" align="center">
              <div slot-scope="{ row }" class="photo">
          ...
          <el-table :data="secondTableData">
            <el-table-column width="60" label="#" align="center">
              <div slot-scope="{ row }" class="checkbox-cell">
                <BaseCheckbox v-model="row.checked"></BaseCheckbox>
              </div>
            </el-table-column>
            <el-table-column prop="name" min-width="180" label="Product Name"> </el-table-column>
            <el-table-column prop="type" min-width="180" label="Type"> </el-table-column>
            <el-table-column label="Milestone" min-width="130">
              <div slot-scope="{ row }">
                <BaseProgress :value="row.progress" :label="row.progressText" value-position="right" />
              </div>
            </el-table-column>
            <el-table-column prop="quantity" min-width="80" align="center" label="QTY"> </el-table-column>
            <el-table-column prop="price" min-width="120" align="right" label="Price"> </el-table-column>
            <el-table-column prop="amount" min-width="120" align="right" label="Amount"> </el-table-column>
          </el-table>
        </div>
      </div>
    </card>
