        ...
        <card type="timeline" class="card-plain">
          <TimeLine type="simple">
            ...
            <TimeLineItem inverted badge-type="info" badge-icon="tim-icons icon-planet">
              ...
              <BaseDropdown slot="footer" title-classes="btn btn-round btn-info">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6">
        <card type="pricing" class="card-primary card-white" footer-classes="text-center mb-3 mt-3">
          ...
          <BaseButton slot="footer" round type="primary" class="btn-just-icon"> Get started </BaseButton>
        </card>
      </div>
...
<script>
  ...
  import { BaseSwitch, TimeLine, TimeLineItem } from '@/components';
